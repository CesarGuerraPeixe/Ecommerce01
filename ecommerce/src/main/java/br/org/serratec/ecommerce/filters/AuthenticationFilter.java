...
public class AuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (token != null) {
			String subject = jwtTokenService.getSubjectFromToken(token); // Pega o subject do Jwt - ou seja, o e-mail do
																			// usuário
			...
			Authentication authentication = new UsernamePasswordAuthenticationToken(userDetails.getUser().getEmail(),
